...
{		
	...
	public:
		...
		TEST_METHOD(MaxValueZero1st) {
			auto func = [] {
				std::shared_ptr<IBusReader> mainDataReader(new FakeStationData());
		...
		TEST_METHOD(MaxValueMany1st) {
			...
			Assert::AreEqual(correctMax, max, L"averageDuration did not return the correct mean for Buss before 30000 seconds");
		}
		...
		TEST_METHOD(MinValueMany1st) {
			...
			Assert::AreEqual(correctMin, min, L"averageDuration did not return the correct mean for Buss before 30000 seconds");
		}
		...
		TEST_METHOD(MeanValueMany1st) {
			...
			Assert::AreEqual(correctMean, mean, 0.0002, L"averageDuration did not return the correct mean for first 25 Buss.");
		}
	...
	*/
		...
		TEST_METHOD(MeanPassengersBus1st) {
			...
			double mean = s.averagePassengersBus("Bus-05");
			Assert::AreEqual(correctMean, mean, 0.0002, L"averageDuration did not return the correct mean for Bus-05");
		}
